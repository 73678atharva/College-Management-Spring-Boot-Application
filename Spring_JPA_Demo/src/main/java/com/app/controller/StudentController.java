...
public class StudentController {
	...
	@PutMapping("/currentStudent/update")
	public ResponseEntity<?> updateCurrentStudentDetails(@RequestBody Student student){		
		StudentDTO existingStudent = studentService.updateCurrentStudentDetails(student);
		return ResponseEntity.status(HttpStatus.FOUND).body(existingStudent);
	}
